...
| 指令 | 功能 |
| --- | --- |
| `mc群服绑定<服务器>` | 将当前群绑定到指定服务器 |
| `mc群服解绑<服务器>` | 解除当前群与指定服务器的绑定 |
| `mc查看 [服务器]` | 查询服务器在线状态 |
| `mc广播 [服务器] <内容>` | 向服务器广播公告消息 |
| `mcrcon [服务器] <指令>` | 通过 RCON 向服务器执行 Minecraft 指令 |
| `mc刷新rcon连接 [服务器]` | 刷新与服务器的 RCON 连接 |
| `mc刷新ws连接` | 重新加载服务器配置并刷新所有 WebSocket 连接 |
